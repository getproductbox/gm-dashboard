...
serve(async (req) => {
  ...
  try {
    console.log('=== STARTING SQUARE BACKFILL FOR MANOR ===');
    ...
    const locationId = 'MANOR_LOCATION_ID'; // ← TODO: Replace with actual Manor location ID
    ...
    console.error('❌ Error in square-sync-backfill-manor function:', error);
