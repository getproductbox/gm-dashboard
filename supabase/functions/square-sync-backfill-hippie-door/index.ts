...
serve(async (req) => {
  ...
  try {
    console.log('=== STARTING SQUARE BACKFILL FOR HIPPIE DOOR ===');
    ...
    const locationId = 'HIPPIE_DOOR_LOCATION_ID'; // ← TODO: Replace with actual Hippie Door location ID
    ...
    console.error('❌ Error in square-sync-backfill-hippie-door function:', error);
